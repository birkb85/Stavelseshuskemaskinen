...
audioUrls[0] = "sounds/recording0";
audioUrls[1] = "sounds/recording1";
setModePlay();
...
function playButtonOnClick(recordingIndex) {
  ...
  //downloadFile(audioUrls[recordingIndex], "recording" + recordingIndex);
}

function downloadFile(audioUrl, fileName) {
